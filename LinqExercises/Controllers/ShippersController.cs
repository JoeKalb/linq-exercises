...
namespace LinqExercises.Controllers
{
    public class ShippersController : ApiController
    {
        ...
        public IHttpActionResult GetFreightReport()
        {
            ...
            //Write a query to return an array of anonymous objects that have two properties. A Shipper property and the freight totals for that shipper labelled as 'FreightTotals' rounded to the nearest whole number from the Orders table, ordered by FreightTotals in descending order.
            var results = _db.Shippers.Select( s => new
                          {
                              Shipper = s.ShipperID,
